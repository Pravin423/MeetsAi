...
export const AgentsView = () => {
    ...
    return (
        <div className="flex-1 pb-4 md:px-8 flex flex-col gap-y-4">
            ...
            totalPages={data.totalPages} onPageChange={(page)=>setFilters({page})}/>
            {data.items.length === 0 && (
                <EmptyState
                    title="Create Your First Agent"
                    description="Create an agent to join your meetings. Each agent can follow your instructions and can interact with participants during your call"
                />
            )}
        </div>
    );
